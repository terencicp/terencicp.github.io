...
const projectsData = [
  {
    ...
    description:
      "Personal web app used to quickly plan meals using predefined food groups, focused on calorie control.",
    technologies: ["JavaScript", "React", "Tailwind CSS"],
    buttons: [
      {
        icon: Github,
        label: "Code",
        url: "https://github.com/terencicp/meal-prep",
      },
      {
        icon: Globe,
        label: "Demo",
        url: "https://meal-preparation.vercel.app/",
      },
    ],
  },
  {
    ...
    description:
      "Automated pipeline that identifies and summarizes trending topics on Mastodon daily using BERTopic.",
  ...
  },
  {
    ...
    category: "Front-end web development",
    description:
      "Web app built as a prototype for a retail client. It allows salespeople to generate quotes, invoices and returns.",
    technologies: ["JavaScript", "React", "Tailwind CSS"],
    buttons: [
      {
        icon: Github,
  ...
  },
  {
    ...
    description:
      "AI agent that given a natural language query can search the web and efficiently extract a list of structured data.",
  ...
  },
  {
    ...
    description:
      "Kaggle notebook showcasing the capabilities of SQL for data analysis. The goal: To perform all data manipulation using SQL only.",
  ...
  },
  {
    ...
    description:
      "Interactive Tableau dashboard exploring games available on the Steam store. Choose a tag to view its statistics and popularity.",
  ...
  },
  {
    ...
    description:
      "Report analising data from 3569 entry-level data analysis jobs, web scraped from LinkedIn.",
  ...
  },
  {
    ...
    category: "Data visualization",
    description:
      "Interactive network plot of collaborations between the top Spotify artists in 2022.",
      ...
      <div className='mb-4'>
        ...
        <div className='flex flex-wrap gap-2'>
          {project.technologies.map((tech) => (
            <span
              key={tech}
              className='bg-sky-100 text-sky-700 px-2 py-1 text-xs rounded-md font-medium'
            >
              {tech}
            </span>
          ))}
        ...
        {project.buttons?.map((button, index) => (
          <a
            ...
            className={`font-medium py-2 px-4 rounded-lg transition-colors text-sm flex items-center justify-center flex-grow ${
              ...
              index === project.buttons.length - 1
